/* 
##### This file was created and copied from            #####
https://github.com/SouthsideSoftware/delcom-indicator  #####
#####                                                  #####
*/
...
class DelcomIndicator {
  ...
  */
  ...
  readButtonState() {
    return this.deviceConnection.getFeatureReport(
      this.readButtonCommand,
      this.readButtonCommandLength
    );
  }
}
